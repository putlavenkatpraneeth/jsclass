...
let x1=products.sort((a,b)=>a.price-b.price).map((a)=>a.price)
console.log(x1);


let arr1=["hello js","hi Js","good jS","welcome JS"];
let x=arr1.map((a)=>a.replace(/js/ig,"react"))
console.log(x);
